...
<span style="color: blue; font-weight: bold">from </span>collections <span style="color: blue; font-weight: bold">import </span>namedtuple<span style="font-weight: bold">, </span>defaultdict<span style="font-weight: bold">, </span>OrderedDict
...
</span>TESTS <span style="font-weight: bold">= </span>OrderedDict<span style="font-weight: bold">()
...
</span><span style="color: blue; font-weight: bold">def </span>test<span style="font-weight: bold">(</span>name<span style="font-weight: bold">):
    </span><span style="color: darkred">"""Decorator to register a test. A test returns a true value on failure."""
    </span><span style="color: blue; font-weight: bold">def </span>new_fn<span style="font-weight: bold">(</span>fn<span style="font-weight: bold">):
        </span>TESTS<span style="font-weight: bold">[</span>name<span style="font-weight: bold">] = </span>Test<span style="font-weight: bold">(</span>fn<span style="font-weight: bold">.</span>__name__<span style="font-weight: bold">, </span>fn<span style="font-weight: bold">)
        </span><span style="color: blue; font-weight: bold">return </span>fn
    <span style="color: blue; font-weight: bold">return </span>new_fn
...
<span style="color: blue; font-weight: bold">def </span>test_all<span style="font-weight: bold">(</span>project_name<span style="font-weight: bold">, </span>tests<span style="font-weight: bold">=</span>TESTS<span style="font-weight: bold">):
    ...
    </span><span style="color: blue; font-weight: bold">for </span>name <span style="color: blue; font-weight: bold">in </span>tests<span style="font-weight: bold">:
        </span>test <span style="font-weight: bold">= </span>tests<span style="font-weight: bold">[</span>name<span style="font-weight: bold">]
...
<span style="color: blue; font-weight: bold">def </span>timed<span style="font-weight: bold">(</span>func<span style="font-weight: bold">, </span>timeout<span style="font-weight: bold">, </span>args<span style="font-weight: bold">=(), </span>kwargs<span style="font-weight: bold">={}):
    ...
    submission <span style="font-weight: bold">= </span>ReturningThread<span style="font-weight: bold">()
        ...
        </span><span style="color: blue; font-weight: bold">raise </span>TimeoutError
    <span style="color: blue; font-weight: bold">if </span>submission<span style="font-weight: bold">.</span>error <span style="color: blue; font-weight: bold">is not </span><span style="color: blue">None</span><span style="font-weight: bold">:
...
<span style="color: blue; font-weight: bold">def </span>check_func<span style="font-weight: bold">(</span>func<span style="font-weight: bold">, </span>tests<span style="font-weight: bold">,
    ...
    Returns 0 for all correct, or the number of tests failed."""
            ...
            </span><span style="color: blue; font-weight: bold">print</span><span style="font-weight: bold">(</span>e<span style="font-weight: bold">.</span>_message<span style="font-weight: bold">)
        ...
        if not </span>comp<span style="font-weight: bold">(</span>val<span style="font-weight: bold">, </span>output<span style="font-weight: bold">):
                ...
                </span><span style="color: blue; font-weight: bold">print</span><span style="font-weight: bold">(</span><span style="color: red">"   returned"</span><span style="font-weight: bold">, </span>out_print<span style="font-weight: bold">(</span>val<span style="font-weight: bold">), </span><span style="color: red">"not"</span><span style="font-weight: bold">, </span>out_print<span style="font-weight: bold">(</span>output<span style="font-weight: bold">))
            </span>code <span style="font-weight: bold">+= </span><span style="color: red">1
...
def </span>underline<span style="font-weight: bold">(</span>s<span style="font-weight: bold">):
        ...
        </span><span style="color: blue; font-weight: bold">for </span>filename <span style="color: blue; font-weight: bold">in </span>filenames<span style="font-weight: bold">:
            </span>path <span style="font-weight: bold">= </span>os<span style="font-weight: bold">.</span>path<span style="font-weight: bold">.</span>join<span style="font-weight: bold">(</span>index<span style="font-weight: bold">, </span>filename<span style="font-weight: bold">)
            </span>data <span style="font-weight: bold">= </span>timed<span style="font-weight: bold">(</span>urllib<span style="font-weight: bold">.</span>request<span style="font-weight: bold">.</span>urlopen<span style="font-weight: bold">, </span><span style="color: red">1</span><span style="font-weight: bold">, </span>args<span style="font-weight: bold">=(</span>path<span style="font-weight: bold">,))
            </span>remotes<span style="font-weight: bold">[</span>filename<span style="font-weight: bold">] = </span>data<span style="font-weight: bold">.</span>read<span style="font-weight: bold">().</span>decode<span style="font-weight: bold">(</span><span style="color: red">'utf-8'</span><span style="font-weight: bold">)
    ...
    </span>parser <span style="font-weight: bold">= </span>argparse<span style="font-weight: bold">.</span>ArgumentParser<span style="font-weight: bold">(</span>description<span style="font-weight: bold">=</span><span style="color: red">'Autograder for CS 61A.'</span><span style="font-weight: bold">)
        ...
        </span>args<span style="font-weight: bold">.</span>question <span style="font-weight: bold">= </span>args<span style="font-weight: bold">.</span>question<span style="font-weight: bold">.</span>upper<span style="font-weight: bold">()
    ...
    </span><span style="color: blue; font-weight: bold">elif </span>args<span style="font-weight: bold">.</span>question <span style="color: blue; font-weight: bold">in </span>TESTS<span style="font-weight: bold">:
        </span>tests <span style="font-weight: bold">= {</span>args<span style="font-weight: bold">.</span>question<span style="font-weight: bold">: </span>TESTS<span style="font-weight: bold">[</span>args<span style="font-weight: bold">.</span>question<span style="font-weight: bold">]}
    </span><span style="color: blue; font-weight: bold">else</span><span style="font-weight: bold">:
